...
export class Migration1740611943202 implements MigrationInterface {
    name = 'Migration1740611943202'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "pack" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "cardSetId" integer, CONSTRAINT "UQ_b9cda684433ba93448b33267333" UNIQUE ("name"), CONSTRAINT "PK_c125718b999b41a621b0d799e02" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TABLE "card_set" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "logo" character varying NOT NULL DEFAULT '', "symbol" character varying NOT NULL DEFAULT '', "external_id" character varying NOT NULL, "releaseDate" TIMESTAMP NOT NULL DEFAULT '2000-01-01', "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_fc8167449e2c751d0ca5fe48958" UNIQUE ("name"), CONSTRAINT "UQ_ff14a31ffd4304ec32fe1fd85d6" UNIQUE ("external_id"), CONSTRAINT "PK_d0a1f698623cc95750422e1aeae" PRIMARY KEY ("id"))`);
